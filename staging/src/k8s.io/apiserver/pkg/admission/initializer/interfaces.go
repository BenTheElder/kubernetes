...
type ValidatingWebhookManifestLoadFunc func(dir string) ([]*admissionregistrationv1api.ValidatingWebhookConfiguration, []byte, error)

// MutatingWebhookManifestLoadFunc loads MutatingWebhookConfiguration manifests from a directory.
type MutatingWebhookManifestLoadFunc func(dir string) ([]*admissionregistrationv1api.MutatingWebhookConfiguration, []byte, error)

// PolicyManifestLoadFunc loads ValidatingAdmissionPolicy manifests from a directory.
type PolicyManifestLoadFunc func(dir string) ([]*admissionregistrationv1api.ValidatingAdmissionPolicy, []*admissionregistrationv1api.ValidatingAdmissionPolicyBinding, []byte, error)

// MutatingPolicyManifestLoadFunc loads MutatingAdmissionPolicy manifests from a directory.
type MutatingPolicyManifestLoadFunc func(dir string) ([]*admissionregistrationv1api.MutatingAdmissionPolicy, []*admissionregistrationv1api.MutatingAdmissionPolicyBinding, []byte, error)
...
type ManifestLoaders struct {
	...
	// LoadPolicyManifests loads ValidatingAdmissionPolicy manifests.
	LoadPolicyManifests PolicyManifestLoadFunc
